...
const Signup = () => {
  ...
  const SignupAxios = () => {
    axios
      .post("http://13.125.151.93/user/signup", {
  ...
  return (
    <div className="Signup_container">
      ...
      <div className="Signup_two_container">
        <div>
          <p>아이디</p> <input type="text" ref={id_ref} />
        </div>

        <div>
          <p>비밀번호</p> <input type="password" ref={pw_ref} />
        </div>

        <div>
          <p>비밀번호 확인</p> <input type="password" ref={pwcheck_ref} />
        </div>
      ...
      <div className="Signup_btn">
        <button className="Signup_back" onClick={SignupCancel}>
          {" "}
          뒤로가기{" "}
        </button>
        <button className="Signup_Signup" onClick={SignupAxios}>
          {" "}
          회원가입{" "}
        </button>
      </div>
